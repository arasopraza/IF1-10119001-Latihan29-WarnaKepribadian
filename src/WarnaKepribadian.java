 ...
 * berdasarkan warna, dimana user menginputkan
 */

public class WarnaKepribadian {
    static Scanner scanner;
    String warnaFavorit, nama;
    ...
    public static void main(String[] args) {
        WarnaKepribadian main = new WarnaKepribadian();
